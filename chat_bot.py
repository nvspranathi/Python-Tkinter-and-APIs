...
app_header = tk.Label(root,text="MY CHAT BOT",font=("Georgia",20),bg="BLACK",fg="WHITE")
...
bot_screen.tag_config("user",foreground="BLUE",font=("Georgia",12))

# scrolled text for the user
user_space = scrolledtext.ScrolledText(root,wrap=tk.WORD,bg="LIGHT GREY",height=2,width=80)
user_space.pack()

# submit button
submit_button = tk.Button(root,text="Submit",height=2,width=10,command=OnClick_Submit)
submit_button.pack(anchor=tk.CENTER,padx=10)
